      ...
      item && (
        <RowComponent
          ...
          styles={{
            ...
            borderRadius: 100,
            borderWidth: 0.5,
            borderColor: appColors.gray2_t,
            marginBottom: 8,
          }}>
          <TextComponent text={item.label} flex={0} />
          <SpaceComponent width={8} />
          <AntDesign name="close" size={14} color={appColors.text_t} />
        </RowComponent>
      )
    );
  };
      ...
      <RowComponent
        ...
        <View style={{flex: 1, paddingRight: 12}}>
          {selected && selected?.length > 0 ? (
            ...
            <TextComponent text="Select" color={appColors.gray2_t} flex={0} />
          )}
        </View>
        <ArrowDown2 size={20} color={appColors.text_t} />
      </RowComponent>
