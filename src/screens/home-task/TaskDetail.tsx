          ...
          <View style={{marginTop: 20}}>
            ...
            <RowComponent styles={{justifyContent: 'space-between'}}>
              <RowComponent
                ...
                <Clock size={20} color={appColors.white_t} />
              ...
              {taskDetail.dueDate && (
                <RowComponent
                  ...
                  <CalendarEdit size={20} color={appColors.white_t} />
                  <SpaceComponent width={4} />
          ...
          <RowComponent>
            <View style={{flex: 1}}>
              <Slider
                ...
                thumbTintColor={appColors.success}
                thumbStyle={{
                  borderWidth: 2,
                  borderColor: appColors.white_t,
                }}
                maximumTrackTintColor={appColors.gray2_t}
        ...
        <SectionComponent>
          <RowComponent>
            ...
            <TouchableOpacity onPress={() => setIsVisibleModalSubTask(true)}>
              <AddSquare size={24} color={appColors.success} variant="Bold" />
            </TouchableOpacity>
          </RowComponent>
          <SpaceComponent height={12} />
          {subTasks.length > 0 &&
